...
<form action="?page=salvar-cliente" method="POST">
	...
	<div class="mb-3">
		<label>CPF
				<input type="text" name="cpf_cliente" class="form-control"   maxlength="11" oninput="this.value = this.value.replace(/[^0-9]/g, '')"required>
		</label>
	</div>
	<div class="mb-3">
		<label>E-mail
	...
	<div class="mb-3">
		<label>Telefone
				<input type="telefone" name="telefone_cliente" class="form-control"required>
		</label>
	</div>
	<div class="mb-3">
		<label>Endereço
