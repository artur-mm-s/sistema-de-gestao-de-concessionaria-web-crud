...
<form action="?page=salvar-modelo" method="POST">
	...
	<div class="mb-3">
		<label>Nome
				<input type="text" name="nome_modelo" class="form-control" value="<?php print $row->nome_modelo; ?>"required>
		</label>
	</div>
	<div class="mb-3">
		<label>Cor
				<input type="text" name="cor_modelo" class="form-control" value="<?php print $row->cor_modelo; ?>"required> 
		</label>
	</div>
	<div class="mb-3">
		<label>Ano
				<input type="number" name="ano_modelo" class="form-control" value="<?php print $row->ano_modelo; ?>"required>
		</label>
	</div>
	<div>
